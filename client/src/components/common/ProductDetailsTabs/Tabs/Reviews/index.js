    ...
    <Container>
      ...
      <List sx={{ margin: '0 auto ' }}>
        <ListItem>
          ...
          <ListItemText>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis, quia Lorem ipsum
            dolor
            sit amet, consectetur adipisicing elit. Alias amet exercitationem maxime natus, nemo nostrum
            odio
            optio provident repellendus voluptas! Dolor hic obcaecati sit vero!!
          </ListItemText>
        </ListItem>
        ...
        <ListItem>
          ...
          <ListItemText>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis, quia Lorem ipsum
            dolor
            sit amet, consectetur adipisicing elit. Alias amet exercitationem maximero!!
          </ListItemText>
        </ListItem>
        <Divider variant='inset' component='li' />
        <ListItem>
